...
for r = 1:rounds
    % Generate new random bids for each buyer for Replication 10
...
% Display final results for Replication 10
fprintf('Total Profits (Replication 10): [%d, %d, %d]\n', total_profits(1), total_profits(2), total_profits(3));
fprintf('Overall Social Welfare (Replication 10): %d\n', overall_social_welfare);
