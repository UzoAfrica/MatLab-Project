...
for r = 1:rounds
    % Generate new random bids for each buyer for Replication 5
...
% Display final results for Replication 5
fprintf('Total Profits (Replication 5): [%d, %d, %d]\n', total_profits(1), total_profits(2), total_profits(3));
fprintf('Overall Social Welfare (Replication 5): %d\n', overall_social_welfare);
