...
for r = 1:rounds
    % Generate new random bids for each buyer for Replication 6
...
% Display final results for Replication 6
fprintf('Total Profits (Replication 6): [%d, %d, %d]\n', total_profits(1), total_profits(2), total_profits(3));
fprintf('Overall Social Welfare (Replication 6): %d\n', overall_social_welfare);
