...
for r = 1:rounds
    % Generate new random bids for each buyer for Replication 4
...
% Display final results for Replication 4
fprintf('Total Profits (Replication 4): [%d, %d, %d]\n', total_profits(1), total_profits(2), total_profits(3));
fprintf('Overall Social Welfare (Replication 4): %d\n', overall_social_welfare);
