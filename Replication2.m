...
for r = 1:rounds
    % Generate new random bids for each buyer for Replication 2
...
% Display final results for Replication 2
fprintf('Total Profits (Replication 2): [%d, %d, %d]\n', total_profits(1), total_profits(2), total_profits(3));
fprintf('Overall Social Welfare (Replication 2): %d\n', overall_social_welfare);
